...
\restrict Udp27hM1k7jWQdeCLXSgJN66xy1TrwXowe6YgyvKs4bYqtORRzIMPFuH2k97uRJ
...
DROP POLICY IF EXISTS "Public frames are viewable by everyone" ON public.canva_frames;
DROP POLICY IF EXISTS "Authenticated users can view frames" ON public.canva_frames;
...
DROP POLICY IF EXISTS "Admins can manage frames" ON public.canva_frames;
...
ALTER TABLE IF EXISTS ONLY public.templates DROP CONSTRAINT IF EXISTS templates_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.templates DROP CONSTRAINT IF EXISTS templates_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.templates DROP CONSTRAINT IF EXISTS templates_classification_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.templates DROP CONSTRAINT IF EXISTS templates_category_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.photos DROP CONSTRAINT IF EXISTS photos_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.canva_frames DROP CONSTRAINT IF EXISTS canva_frames_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.albums DROP CONSTRAINT IF EXISTS albums_user_id_fkey;
...
DROP INDEX IF EXISTS public.idx_templates_classification_type_id;
...
DROP INDEX IF EXISTS public.idx_photos_capture_date;
DROP INDEX IF EXISTS public.idx_canva_frames_type;
DROP INDEX IF EXISTS public.idx_canva_frames_public;
DROP INDEX IF EXISTS public.idx_canva_frames_frame_type;
DROP INDEX IF EXISTS public.idx_canva_frames_category;
...
ALTER TABLE IF EXISTS ONLY public.user_roles DROP CONSTRAINT IF EXISTS user_roles_code_key;
ALTER TABLE IF EXISTS ONLY public.templates DROP CONSTRAINT IF EXISTS templates_pkey;
ALTER TABLE IF EXISTS ONLY public.template_types DROP CONSTRAINT IF EXISTS template_types_pkey;
ALTER TABLE IF EXISTS ONLY public.template_types DROP CONSTRAINT IF EXISTS template_types_code_key;
ALTER TABLE IF EXISTS ONLY public.template_classifications DROP CONSTRAINT IF EXISTS template_classifications_pkey;
ALTER TABLE IF EXISTS ONLY public.template_classifications DROP CONSTRAINT IF EXISTS template_classifications_code_key;
ALTER TABLE IF EXISTS ONLY public.template_categories DROP CONSTRAINT IF EXISTS template_categories_pkey;
ALTER TABLE IF EXISTS ONLY public.template_categories DROP CONSTRAINT IF EXISTS template_categories_code_key;
ALTER TABLE IF EXISTS ONLY public.profiles DROP CONSTRAINT IF EXISTS profiles_pkey;
ALTER TABLE IF EXISTS ONLY public.photos DROP CONSTRAINT IF EXISTS photos_pkey;
ALTER TABLE IF EXISTS ONLY public.canva_frames DROP CONSTRAINT IF EXISTS canva_frames_pkey;
...
ALTER TABLE IF EXISTS public.template_types ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.template_classifications ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.template_categories ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.template_classifications_id_seq;
DROP TABLE IF EXISTS public.template_classifications;
DROP SEQUENCE IF EXISTS public.template_categories_id_seq;
DROP TABLE IF EXISTS public.template_categories;
DROP TABLE IF EXISTS public.profiles;
DROP TABLE IF EXISTS public.photos;
DROP TABLE IF EXISTS public.canva_frames;
...
DROP FUNCTION IF EXISTS public.update_user_role(target_user_id uuid, new_role_id integer);
...
--
-- Name: handle_role_update(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.handle_role_update() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare
  role_code text;
...
--
-- Name: update_user_role(uuid, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_user_role(target_user_id uuid, new_role_id integer) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
...
--
-- Name: canva_frames; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.canva_frames (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    name text NOT NULL,
    path text NOT NULL,
...
--
-- Name: TABLE canva_frames; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN canva_frames.frame_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN canva_frames.svg_content; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: template_classifications; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: template_classifications_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: template_classifications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: template_types; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: template_types_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: template_types_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: template_categories id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: template_classifications id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: template_types id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: canva_frames canva_frames_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_categories template_categories_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_classifications template_classifications_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_classifications template_classifications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_types template_types_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: template_types template_types_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_roles user_roles_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_canva_frames_category; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_canva_frames_frame_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_canva_frames_public; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_canva_frames_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_photos_capture_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_templates_category_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_templates_classification_type_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: profiles on_role_change; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER on_role_change AFTER INSERT OR UPDATE OF role_id ON public.profiles FOR EACH ROW EXECUTE FUNCTION public.handle_role_update();
...
--
-- Name: albums albums_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: canva_frames canva_frames_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: templates templates_classification_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: templates templates_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: canva_frames Admins can manage frames; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: photos Anyone can insert photos; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: canva_frames Authenticated users can view frames; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: canva_frames Public frames are viewable by everyone; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: photos Public photos access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: templates Service role can modify templates; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: albums Users can delete own albums; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: albums Users can insert own albums; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: albums Users can update own albums; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: albums Users can view own albums; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: canva_frames; Type: ROW SECURITY; Schema: public; Owner: -
--
...
CREATE POLICY "Allow Authenticated Uploads" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'photos'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Allow Public Access; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow Public Access" ON storage.objects FOR SELECT USING ((bucket_id = 'photos'::text));


--
-- Name: objects Allow Public Access - Photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow Public Access - Photos" ON storage.objects FOR SELECT USING ((bucket_id = 'photos'::text));


--
-- Name: objects Allow User Delete; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow User Delete" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'photos'::text) AND (owner = auth.uid())));


--
-- Name: objects Allow User Delete - Photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow User Delete - Photos" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'photos'::text) AND (owner = auth.uid())));


--
-- Name: objects Allow User Update; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow User Update" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'photos'::text) AND (owner = auth.uid()))) WITH CHECK (((bucket_id = 'photos'::text) AND (owner = auth.uid())));


--
-- Name: objects Allow User Update - Photos; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Allow User Update - Photos" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'photos'::text) AND (owner = auth.uid()))) WITH CHECK (((bucket_id = 'photos'::text) AND (owner = auth.uid())));


--
-- Name: objects Avatars: Delete own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Avatars: Delete own" ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'avatars'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));


--
-- Name: objects Avatars: Insert own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Avatars: Insert own" ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'avatars'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
...
--
-- Name: objects Avatars: Update own; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Avatars: Update own" ON storage.objects FOR UPDATE TO authenticated USING (((bucket_id = 'avatars'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text))) WITH CHECK (((bucket_id = 'avatars'::text) AND ((storage.foldername(name))[1] = (auth.uid())::text)));
...
\unrestrict Udp27hM1k7jWQdeCLXSgJN66xy1TrwXowe6YgyvKs4bYqtORRzIMPFuH2k97uRJ
